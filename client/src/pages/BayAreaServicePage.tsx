...
const HERO_IMG = "/assets/pfs-service-hero-img_017cbbfb.jpg";
    ...
    jsonLd: [
      {
        ...
        "@type": "LocalBusiness",
        "name": "PFS Industrial Finishing Equipment — Bay Area Spray Booth Service",
    ...
    <div style={{ background: "#f8f9fa", minHeight: "100vh" }}>
      ...
      <section style={{ background: "#f8f9fa", padding: "64px 2rem" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div data-animation="fadeIn" style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center", marginBottom: 40 }}>
