...
export default function PrepStationsPage() {
  ...
  return (
    <div className="bg-white">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Exhaust wall prep stations with curtain or fully enclosed ceiling
              configurations. Single and multi-bay layouts for body shops, collision
              centers, and industrial finishing lines.
            </p>
            ...
            >
              <Link
                data-animation="slideLeft"
                href="/contact/request-a-quote?from=prep-station"
                className="btn-glow"
                style={{
                  fontFamily: "'Barlow Condensed', sans-serif",
                  fontWeight: 700,
        ...
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                PFS Orion Prep Stations are dedicated stations for sanding, masking,
                and prep work — keeping those tasks separate from the spray booth.
              </p>
              ...
              >
                ...
                <strong>exhaust wall with curtain sides</strong> for maximum
                flexibility and easy vehicle access, or{" "}
                <strong>fully enclosed ceiling</strong> with optional built-in LED
                lighting for a cleaner, more controlled prep environment. Multi-bay
                configurations allow multiple technicians to work simultaneously.
              </p>
      ...
      {/* ── CONFIGURATIONS ── */}
      <section style={{ background: "#f5f5f5", paddingTop: "64px", paddingBottom: "64px" }}>
        ...
        >
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              >
                PFS Orion Prep Stations are designed to expand. Add bays side-by-side
                to create a dedicated prep line — each bay with its own exhaust
                section, curtain separation, and independent airflow control.
              </p>
              ...
              >
                Multi-bay configurations are common in high-volume collision
                centers, fleet shops, and industrial finishing operations where
                multiple vehicles or parts need to be prepped simultaneously.
              </p>
              ...
              <div>
                ...
                >
                  {DEPTHS.map((d) => (
                    <button
                      key={d}
                      onClick={() =>
                        setSelectedDepth((prev) => (prev === d ? null : d))
                      }
                      style={{
                        fontFamily: "'Barlow Condensed',sans-serif",
                        fontWeight: 700,
                        ...
                        border: `2px solid ${selectedDepth === d ? BLUE : "#ccc"
                          }`,
                        background: selectedDepth === d ? BLUE : "#fff",
                        color: selectedDepth === d ? "#fff" : "#333",
                        cursor: "pointer",
                ...
                {selectedDepth && selectedDepth !== "Custom" && (
                  ...
                  >
                    ...
                    >
                      Standard configuration — custom sizes available on request
                    </div>
                  </div>
                )}
                ...
                {selectedDepth === "Custom" && (
                  ...
                  >
                    ...
                    >
                      Contact us for custom width, height, or depth configurations.
                    </div>
      ...
      {/* ── GALLERY ── */}
      <section style={{ background: "#111", paddingTop: "64px", paddingBottom: "64px" }}>
        <div className="container">
      ...
      {/* ── CTA BAND ── */}
      <section style={{ background: BLUE, paddingTop: "64px", paddingBottom: "64px" }}>
      ...
      {/* FAQ SECTION */}
      <section style={{ background: "#f8f9fb", paddingTop: "64px", paddingBottom: "64px", borderTop: "1px solid #e5e7eb" }}>
