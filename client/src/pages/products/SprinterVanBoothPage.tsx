        ...
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem", justifyContent: "center" }}>
            ...
            <a data-animation="slideRight"
              href="tel:8885457715" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "transparent", color: "#fff", border: "2px solid rgba(255,255,255,0.5)", fontFamily: "'Barlow Condensed',sans-serif", fontSize: "0.9rem", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", padding: "1rem 2.5rem" }}>
              CALL (888) 545-7715
            </a>
          </div>
        </div>
