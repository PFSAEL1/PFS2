...
/* ── CDN ASSETS ── */
const HERO_IMG = "/assets/pfs-sprinter-van-mercedes-clean_84aa20f4.jpg";  // Mercedes Sprinter front-face inside white booth (cropped)
const FEATURED_IMG = "/assets/pfs-sprinter-van-ford-clean_9a7301c8.jpg";     // Ford Transit in PFS booth — exterior front with PFS banner (cropped)

/* ── GALLERY ── */
const GALLERY: GalleryImage[] = [
  { src: "/assets/pfs-sprinter-van-ford-clean2_776c69bb.png", alt: "Ford Transit van inside PFS spray booth — exterior front view with PFS branding" },
  { src: "/assets/pfs-sprinter-van-masked_c831c0bb.jpg", alt: "Mercedes Sprinter van masked and prepped for paint inside PFS spray booth with yellow scaffolding" },
  { src: "/assets/van_interior_front_door_9481d35f.jpg", alt: "PFS Sprinter Van booth interior from front door" },
  { src: "/assets/van_exterior_side_duct_478892a9.jpg", alt: "PFS Sprinter Van booth exterior side with ductwork" },
  { src: "/assets/van_exterior_front_pfs_banner_9cffb3d7.jpg", alt: "PFS Sprinter Van booth exterior front with branding" },
  { src: "/assets/van_interior_side_wall_a46fe5ec.jpg", alt: "PFS Sprinter Van booth interior side wall with ceiling lights" },
  { src: "/assets/van_exterior_side_open_door_3d4424a5.jpg", alt: "PFS Sprinter Van booth compact exterior with control panel" },
  { src: "/assets/van_exterior_side_open_door_3d4424a5.jpg", alt: "PFS Sprinter Van booth exterior side with open door" },
];
...
/* ── YOU MAY ALSO LIKE ── */
const ALL_RELATED = [
  { label: "Cross-Flow Booths", href: "/products/paint-booths/crossflow", img: "/assets/orion-crossflow-render-v3_63c04d8e.webp", desc: "Horizontal airflow — most cost-effective enclosed booth for automotive and fleet finishing." },
  { label: "Side Downdraft Booths", href: "/products/paint-booths/side-downdraft", img: "/assets/pfs_helios_side_angle_final_73768c1f_5eaf3967.png", desc: "Side-wall exhaust plenums — no pit required, excellent finish quality." },
  { label: "Full Downdraft Booths", href: "/products/paint-booths/full-downdraft", img: "/assets/pfs_zenith_booth_v2_d56f2cd8_d3f181cd.png", desc: "Vertical downdraft through a concrete pit — highest finish quality available." },
  { label: "Heated Paint Booths", href: "/products/paint-booths/heated", img: "/assets/heated_exterior_front_pfs_60f51615.jpg", desc: "Add spray, flash, and bake modes to any van booth — up to 180°F cure cycles." },
  { label: "Air Make-Up Units", href: "/products/air-make-up-units", img: "/assets/pfs-amu-card_41f0dd88.jpg", desc: "Tempered, filtered make-up air to maintain positive pressure and code compliance." },
  { label: "Semi-Downdraft Booths", href: "/products/paint-booths/semi-downdraft", img: "/assets/orion-crossflow-render-v3_63c04d8e.webp", desc: "Ceiling intake with rear-wall exhaust — no pit, better finish than cross-flow." },
];
...
export default function SprinterVanBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "Product",
      "name": "Sprinter Van Spray Booth",
      "description": "PFS Sprinter van spray booths sized for Mercedes Sprinters, Ford Transits, and similar commercial vans. 11-12 ft interior height, ETL listed.",
      "brand": {
        "@type": "Brand",
        "name": "PFS"
      },
      ...
      "offers": {
        ...
        "url": "https://pfsspraybooths.com/products/paint-booths/sprinter-van-booth"
      },
      "url": "https://pfsspraybooths.com/products/paint-booths/sprinter-van-booth"
    },
  });
    ...
    >
        ...
        <div className="container">
          ...
          <div style={{ maxWidth: "700px", margin: "0 auto" }}>
            ...
            {activeFlow === "side" && (
              <div>
                <div style={{ textAlign: "center" }}>
                  <img src="/assets/side_downdraft_helios_smooth_splitflow_eada3110_fd6fb8dd.gif" alt="Side Downdraft Helios airflow diagram" style={{ maxWidth: "100%", width: "700px", height: "auto" }} />
                </div>
                <p style={{ fontFamily: "'Inter',sans-serif", fontSize: "0.88rem", color: "#555", textAlign: "center", marginTop: "1.25rem", lineHeight: 1.7, maxWidth: "520px", margin: "1.25rem auto 0" }}>
      ...
      <section style={{ background: "#f5f5f5", padding: "4rem 0" }}>
        <div className="container">
          ...
          <div data-animation="fadeIn" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(260px,1fr))", gap: "1.5rem" }}>
            {related.map(p => (
