...
// ── HERO VIDEO ──
const HERO_VIDEO = "/assets/pfs-wash-booth-hero_b17b92ab.mp4";

// ── FEATURED PRODUCT — Helios interior with equipment ──
const FEATURED_IMG = "/assets/pfs-wash-booth-helios-featured_0fc278aa.png";

// ── OLD HERO — moved to gallery ──
const OLD_HERO_IMG = "/assets/washbooth_75284018.png";

// ── GALLERY ──
const GALLERY_IMGS = [
  { src: "/assets/pfs-wash-booth-man-washing_86c386b9.png", alt: "Technician pressure washing engine block inside PFS industrial wash booth", pos: "center 50%" },
  { src: "/assets/pfs-wash-booth-interior-be-washer_c61ffc7c.png", alt: "PFS wash booth interior — BE pressure washer and hose reel, steel grating floor", pos: "center 50%" },
  { src: "/assets/pfs-wash-booth-helios-featured_0fc278aa.png", alt: "PFS Helios wash booth — fully equipped interior with hose reel and steam tank", pos: "center 40%" },
...
const PRODUCTS = [
  { label: "Pretreatment Systems", href: "/integration-automation/pretreatment-systems", img: "/assets/washbooth_75284018.png", desc: "Automated chemical pretreatment systems for cleaning, phosphating, and surface prep before coating." },
  { label: "Batch Ovens", href: "/products/ovens/batch", img: "/assets/orig-render-batch-oven_3d3b6c3f.webp", desc: "Industrial batch ovens for dry-off and curing after the wash process." },
  { label: "Enclosed Paint Booths", href: "/products/paint-booths/enclosed", img: "/assets/pfs_helios_side_angle_final_73768c1f_5eaf3967.png", desc: "Full-enclosure spray booths for superior overspray containment and finish quality." },
...
export default function WashBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "Product",
      "name": "Industrial Wash Booth",
      "description": "PFS wash booths provide a contained, ventilated environment for industrial parts washing and cleaning prior to coating operations.",
      "brand": {
        "@type": "Brand",
        "name": "PFS"
      },
      ...
      "offers": {
        ...
        "url": "https://pfsspraybooths.com/products/prep/wash-booth"
      },
      "url": "https://pfsspraybooths.com/products/prep/wash-booth"
    },
  });
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "8rem", paddingBottom: "4.5rem" }}>
          ...
          >
            <Link
              ...
              href="/contact/request-a-quote?from=wash-booth"
            ...
            >
              <span
                className="btn-glow-white flex w-full md:w-auto items-center justify-center"
                style={{
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-2 md:order-1">
              ...
              >
                <span
                  data-animation="slideRight"
                  className="btn-glow flex w-full md:inline-flex md:w-auto items-center justify-center"
                >
      ...
      <section style={{ padding: "3rem 0 4rem", background: "#fff" }}>
        <div className="container">
          ...
          <div data-animation="slideRight" className="text-center">
            ...
            >
              <span
                className="btn-glow !w-full md:!w-auto md:!inline-flex items-center justify-center"
              >
                REQUEST A QUOTE <ArrowRight size={15} />
              </span>
            </Link>
        ...
        <div className="container" style={{ textAlign: "center" }}>
          ...
          >
            <Link
              ...
              className="block w-full md:w-auto"
            >
              <span className="btn-glow-white flex w-full md:w-auto items-center justify-center">
                GET PRICING <ArrowRight size={16} />
              </span>
            </Link>
        ...
        <div className="container" style={{ textAlign: "center" }}>
          ...
          >
            ...
            >
              ...
              >
                VIEW BATCH OVENS <ArrowRight size={13} />
              </span>
            </Link>

            <Link
              data-animation="slideRight"
              href="/integration-automation/pretreatment-systems"
              className="block w-full md:w-auto"
            >
              <span
                className="flex w-full md:w-auto items-center justify-center"
              ...
              >
                VIEW PRETREATMENT SYSTEMS <ArrowRight size={13} />
              </span>
            </Link>
          </div>
        </div>
