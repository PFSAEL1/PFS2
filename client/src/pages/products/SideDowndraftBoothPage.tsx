...
/* ── CDN ASSETS ── */
const HERO_RENDER = "/assets/pfs_helios_side_angle_final_73768c1f_5eaf3967.png";
const FEATURED_IMG = "/assets/helios_angle3_v21_white_411ddec0.png";
const AIRFLOW_GIF = "/assets/side_downdraft_airflow_animation_f31ca9c0.gif";

const GALLERY_IMGS = [
  // ── New real install photos (shown first) ──
  { src: "/assets/pfs-factory-booth-wide_234b773d.jpeg", alt: "PFS factory floor — side-downdraft and crossflow booths side by side, Orion and Helios models", pos: "center 50%" },
  { src: "/assets/pfs-factory-helios-front_9112086e.jpeg", alt: "PFS Helios — front view with triple glass doors, PFS branding, factory floor", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-front-full_04883b65.jpg", alt: "PFS Helios side-downdraft — front view, triple-door entry, Helios badge, installed in shop", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-door-closeup_888f9187.jpg", alt: "PFS Helios side-downdraft — close-up of triple entry doors with Helios branding", pos: "center 40%" },
  { src: "/assets/pfs-helios-sdd-side-angle_9f43d877.jpg", alt: "PFS Helios side-downdraft — side angle view showing AMU plenum and booth body", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-front-angle_77d8d4fa.jpg", alt: "PFS Helios side-downdraft — front angle view showing doors and side plenum", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-install-wide_a6bec064.jpg", alt: "PFS Helios side-downdraft — wide install shot showing full booth and side plenum assembly", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-side-install_fb8a847b.jpg", alt: "PFS Helios side-downdraft — side view during installation showing AMU plenum structure", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-side-rear_fa0388f5.jpg", alt: "PFS Helios side-downdraft — rear side angle showing plenum framing during install", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-plenum-detail_d3b8c678.jpg", alt: "PFS Helios side-downdraft — detail view of side plenum filter bays and framing", pos: "center 50%" },
  { src: "/assets/pfs-helios-sdd-jcb-install_cd269044.jpg", alt: "PFS Helios side-downdraft — installation in progress with JCB telehandler lifting booth panels", pos: "center 50%" },
  // ── Earlier gallery photos ──
  { src: "/assets/pfs_helios_side_angle_final_73768c1f_5eaf3967.png", alt: "PFS Helios Side Downdraft — installed in shop, front-side angle view", pos: "center 40%" },
  { src: "/assets/1000084527_2d16f905.jpeg", alt: "PFS Helios — side view showing side plenums and exhaust stacks", pos: "center 45%" },
  { src: "/assets/1000084532_1ff59b12.jpeg", alt: "PFS Helios — interior view showing teal ceiling filters and lighting", pos: "center 50%" },
  { src: "/assets/IMG_2009_f1dbc447.jpeg", alt: "PFS Helios — interior side plenum filters and lighting", pos: "center 50%" },
  { src: "/assets/semi-down-interior_8614fbf2.jpg", alt: "PFS Helios — interior angle view showing side plenum filters", pos: "center 45%" },
  { src: "/assets/semi-down-open-doors_1d86b013.jpg", alt: "PFS Helios — front view through open door, interior ceiling filters", pos: "center 40%" },
  { src: "/assets/pfs_helios_side_angle_final_4ec28901_f4ff36d7.webp", alt: "PFS Helios — front angle view in shop with exhaust stack", pos: "center 45%" },
  { src: "/assets/helios_outdoor_aerial_f4f0d335.jpg", alt: "PFS Helios — aerial outdoor view showing roof exhaust stacks", pos: "center 50%" },
  { src: "/assets/helios_gallery_img0218_111111f7.jpg", alt: "PFS Helios — additional install photo", pos: "center 50%" },
  { src: "/assets/helios_interior_open_door_c13c37e3.jpg", alt: "PFS Helios — interior view through open doors showing ceiling lights and side plenums", pos: "center 50%" },
  { src: "/assets/helios_side_exterior_angle_de36b808.jpg", alt: "PFS Helios — exterior side angle showing side exhaust plenums and front doors", pos: "center 45%" },
  { src: "/assets/helios_interior_front_d9472d1b.jpg", alt: "PFS Helios — interior view from front showing teal ceiling filters and side exhaust", pos: "center 50%" },
  { src: "/assets/helios_interior_rear_798c7434.jpg", alt: "PFS Helios — interior view from rear showing ceiling filter grid and side plenums", pos: "center 50%" },
  { src: "/assets/helios_interior_side_left_cfca7861.jpg", alt: "PFS Helios — interior side wall showing exhaust filters and lighting fixtures", pos: "center 50%" },
  { src: "/assets/helios_interior_side_right_d5855816.jpg", alt: "PFS Helios — interior opposite side wall with exhaust plenums and ceiling lights", pos: "center 50%" },
  { src: "/assets/helios_interior_front_door_acd48c44.jpg", alt: "PFS Helios — full interior view from front door showing PFS branding", pos: "center 45%" },
];
...
export default function SideDowndraftBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "What is a side-downdraft spray booth?", "acceptedAnswer": { "@type": "Answer", "text": "A side-downdraft spray booth draws fresh air through a full ceiling plenum, moves it straight down through the booth interior, and exhausts it through floor-level side wall plenums on both sides of the booth. No underground concrete pit is required. The PFS Helios series uses this configuration and delivers downdraft-quality finish results at the lowest installed cost of any downdraft-style booth." } },
        { "@type": "Question", "name": "Does a side-downdraft booth require a concrete floor pit?", "acceptedAnswer": { "@type": "Answer", "text": "No. The side-downdraft design exhausts air through side wall plenums at floor level rather than through the floor itself. This eliminates the need for an underground concrete pit, making it the lowest-cost downdraft-style booth to install and ideal for slab-on-grade facilities." } },
        { "@type": "Question", "name": "What is the difference between a side-downdraft and a semi-downdraft spray booth?", "acceptedAnswer": { "@type": "Answer", "text": "A semi-downdraft booth exhausts through a single rear wall plenum, while a side-downdraft booth exhausts through plenums on both side walls at floor level. Side-downdraft provides more uniform airflow across the full width of the booth and is better suited for wider vehicles or parts. Both configurations require no floor pit." } },
        { "@type": "Question", "name": "What certifications does the PFS Helios side-downdraft booth carry?", "acceptedAnswer": { "@type": "Answer", "text": "The PFS Helios side-downdraft spray booth carries ETL listing for both the USA and Canada (Intertek), UL 508A certification on the industrial control panel, NFPA 33 compliance, EPA air quality compliance, and OSHA workplace safety compliance. All fans are UL listed tube axial fans. Lighting fixtures are CID2 rated. Manufactured in Santa Rosa, CA." } },
        { "@type": "Question", "name": "What is the advantage of a side-downdraft booth over a cross-flow booth?", "acceptedAnswer": { "@type": "Answer", "text": "A cross-flow booth moves air horizontally from front to rear, which can push overspray across the part being painted. A side-downdraft booth moves air downward from ceiling to floor, carrying overspray away from the work surface and out through the side wall exhaust plenums. This results in significantly better finish quality and cleaner working conditions than a cross-flow configuration." } }
      ]
    },
  });
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "8rem", paddingBottom: "4.5rem" }}>
          ...
          <div className="flex flex-col min-[768px]:flex-row gap-4 w-full min-[768px]:w-auto">
            <Link
              ...
              href="/contact/request-a-quote?from=side-downdraft-booth"
      ...
      <section style={{ background: "#f5f5f5", padding: "4rem 0 3rem" }}>
        <div className="container">
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            ...
            <div className="flex flex-col min-[768px]:flex-row gap-4 justify-center w-full min-[768px]:w-auto">
              <Link
                data-animation="slideLeft"
                href="/contact/request-a-quote?from=side-downdraft-booth"
                className="w-full min-[768px]:w-auto"
              >
                <span className="btn-glow flex w-full items-center justify-center gap-2 min-[768px]:w-auto">
        ...
        <div className="container">
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", marginBottom: specsOpen ? "2rem" : 0 }}>
            ...
            <button
              ...
              className="w-full min-[768px]:w-auto min-[768px]:inline-flex items-center justify-center gap-2 box-border"
              style={{
                display: "inline-flex",
                alignItems: "center",
              ...
              <div style={{ textAlign: "center" }}>
                ...
                >
                  {featuresOpen ? (
                    ...
                    <>
                      <ChevronDown size={15} /> SEE ALL{" "}
                      {FEATURES_HIDDEN.length + FEATURES_VISIBLE.length} FEATURES
                    </>
                  )}
                </button>
              </div>
      ...
      <section style={{ background: "#111", padding: "3rem 0", borderTop: `4px solid ${BLUE}` }}>
        <div className="container" style={{ textAlign: "center" }}>
          ...
          >
            <span
              data-animation="slideRight"
              className="flex w-full items-center justify-center gap-2 min-[768px]:inline-flex min-[768px]:w-auto"
              style={{
                background: BLUE,
                color: "#fff",
                fontFamily: "'Barlow Condensed', sans-serif",
