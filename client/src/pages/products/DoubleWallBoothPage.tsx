...
const HERO_VIDEO = "/assets/pfs-double-wall-booth-v3-hero_4b7e7175.mp4";
const HERO_POSTER = "/assets/pfs-double-wall-booth-v2_8cdb7a24.webp";
const FEATURED_IMG = "/assets/pfs-dw-featured-zenith_2b530356.webp";
const GALLERY_IMGS = [
  // Real install photos first
  { src: "/assets/dw-zenith-exterior-1_18ffc860.webp", alt: "PFS Zenith double-wall booth — front exterior with double entry doors, installed in customer facility" },
  { src: "/assets/dw-zenith-exterior-2_b5f949b2.png", alt: "PFS Zenith double-wall booth — front view with HVAC stack, installed in open warehouse" },
  { src: "/assets/pfs-walkin-batch-booth-front-wide_4f44f772.jpg", alt: "PFS double-wall panel system — front view with double entry doors, installed in industrial facility" },
  { src: "/assets/pfs-walkin-batch-booth-front-scissor_13c63689.jpg", alt: "PFS double-wall panel system — front view with scissor lift during installation" },
  { src: "/assets/pfs-walkin-batch-booth-side-angle1_9b6faf8e.jpg", alt: "PFS double-wall panel system — side angle view showing panel construction and exhaust stack" },
  { src: "/assets/pfs-walkin-batch-booth-side-angle2_9b7ce2ca.jpg", alt: "PFS double-wall panel system — side angle view during installation" },
  { src: "/assets/IMG_0914_2ebc304c.jpg", alt: "PFS Zenith double-wall booth — real install photo" },
  { src: "/assets/IMG_0938_fc8d1552.jpg", alt: "PFS Zenith double-wall booth — real install photo" },
  { src: "/assets/IMG_0225_3f80eac2.jpg", alt: "PFS Zenith double-wall booth — real install photo" },
  { src: "/assets/IMG_8278_c5cec08c.jpg", alt: "PFS Zenith double-wall booth — real install photo" },
  // Renders / studio shots
  { src: "/assets/pfs-dw-gallery-interior_3fb7ab85.jpg", alt: "PFS Double-Wall Booth Interior — full downdraft grated floor with ceiling plenum" },
  { src: "/assets/pfs-dw-gallery-exterior_09b87952.jpg", alt: "PFS Double-Wall Booth — exterior view with mixing room" },
];
...
const PRODUCTS = [
  ...
  { label: "Cross-Flow Booths", href: "/products/paint-booths/crossflow", img: "/assets/orion-crossflow-render-v3_63c04d8e.webp", desc: "Horizontal airflow — most cost-effective enclosed booth for automotive and industrial finishing." },
];
...
export default function DoubleWallBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "Product",
      "name": "Double Wall Spray Booth",
      "description": "PFS double wall spray booths with insulated panel construction for temperature-sensitive coating operations and energy efficiency.",
      "brand": {
        "@type": "Brand",
        "name": "PFS"
      },
      ...
      "offers": {
        ...
        "url": "https://pfsspraybooths.com/products/paint-booths/double-wall-booth"
      },
      "url": "https://pfsspraybooths.com/products/paint-booths/double-wall-booth"
    },
  });
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "8rem", paddingBottom: "3.5rem" }}>
          ...
          >
            <Link
              ...
              className="w-full min-[768px]:w-auto block"
            >
              <span
                className="btn-glow"
                style={{
      ...
      <section style={{ background: "#fff", padding: "4rem 0" }}>
        <div className="container">
          ...
          <div data-animation="slideRight" style={{ textAlign: "center", marginTop: "2rem" }}>
            ...
            >
              <span
                className="btn-glow w-full min-[768px]:w-auto"
                style={{
                  justifyContent: "center",
                  boxSizing: "border-box",
                }}
