          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0.75rem", width: "100%", maxWidth: "900px" }}>
              {[
                ...
                <div data-animation="slideLeft" key={item.label} style={{ display: "flex", alignItems: "center", gap: "0.5rem", padding: "0.65rem 0.75rem", background: "#fff", border: "1px solid #e5e7eb" }}>
                  {item.icon}
                  <span data-animation="slideLeft" style={{ fontFamily: "'Chakra Petch', 'Barlow Condensed', sans-serif", fontSize: "0.82rem", fontWeight: 700, color: "#111" }}>{item.label}</span>
                </div>
              ))}
            </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                {FEATURES_VISIBLE.map((f) => (
                  <div key={f.num} style={{ background: "#f8f9fb", border: "1px solid #e5e7eb", padding: "1.75rem", display: "flex", flexDirection: "column" }}>
                    ...
                    <Link data-animation="slideRight" href="/contact/request-a-quote?from=heated-booth"><span style={{ display: "inline-flex", alignItems: "center", gap: "0.3rem", fontFamily: "'Chakra Petch', 'Barlow Condensed', sans-serif", fontSize: "0.78rem", fontWeight: 700, color: BLUE, letterSpacing: "0.08em", textTransform: "uppercase", cursor: "pointer" }}>LEARN MORE <ArrowRight size={12} /></span></Link>
                  </div>
                ))}
              </div>
              {featuresOpen && (
        ...
        <div className="container">
          ...
          {sizesOpen && (
            <>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                {SIZES.map((s) => (
                  <div data-animation="slideRight" key={s.model} style={{ background: "#fff", border: `2px solid ${BLUE}`, padding: "1.5rem 1rem", textAlign: "center" }}>
                    ...
                    <Link data-animation="slideRight" href={s.href}><span style={{ display: "inline-flex", alignItems: "center", gap: "0.3rem", fontFamily: "'Chakra Petch', 'Barlow Condensed', sans-serif", fontSize: "0.78rem", fontWeight: 700, color: BLUE, letterSpacing: "0.08em", textTransform: "uppercase", cursor: "pointer" }}>VIEW BOOTH <ArrowRight size={12} /></span></Link>
                  </div>
                ))}
              </div>
      ...
      <section style={{ background: "#f5f5f5", padding: "4rem 0", borderBottom: "1px solid #e5e7eb" }}>
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {MODELS.map((m) => (
              <Link data-animation="slideLeft" key={m.name} href={m.href}>
                <div style={{ display: "flex", flexDirection: "column", border: "2px solid #d0d8e8", overflow: "hidden", cursor: "pointer", background: "#fff" }} className="group hover:border-blue-800 transition-colors">
                  <div style={{ width: "100%", aspectRatio: "4/3", overflow: "hidden", background: "#f5f5f5", position: "relative" }}>
                    <img data-animation="slideLeft" src={m.img} alt={m.name} style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.3s" }} className="group-hover:scale-105" />
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <Link data-animation="slideLeft" key={item.label} href={item.href}>
                <div style={{ display: "flex", flexDirection: "column", border: "2px solid #d0d8e8", overflow: "hidden", cursor: "pointer", background: "#fff" }} className="group hover:border-blue-800 transition-colors">
                  <div style={{ width: "100%", aspectRatio: "4/3", overflow: "hidden", background: "#f5f5f5" }}>
                    <img data-animation="slideLeft" src={item.img} alt={item.label} style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.3s" }} className="group-hover:scale-105" />
                  </div>
                  <div style={{ padding: "1rem 1.1rem 1.2rem" }}>
