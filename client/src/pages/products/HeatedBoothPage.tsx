...
/* ── CDN ASSETS ── */
const HERO_IMG     = "/assets/pfs_zenith_booth_v2_d56f2cd8_d3f181cd.png";
const FEATURED_IMG = "/assets/pfs_zenith_booth_v2_d56f2cd8_d3f181cd.png";

/* ── GALLERY — unique real install photos only ── */
const GALLERY: GalleryImage[] = [
  { src: "/assets/pfs-factory-booth-wide_234b773d.jpeg",    alt: "PFS factory floor — side-downdraft and crossflow booths side by side, Orion and Helios models" },
  { src: "/assets/pfs-factory-helios-front_9112086e.jpeg", alt: "PFS Helios — front view with triple glass doors, PFS branding, factory floor" },
  { src: "/assets/DOWNDRAFTHEATED_3b73ef6f.png",  alt: "PFS heated paint booth — full downdraft heated configuration" },
  { src: "/assets/IMG_0275_heated_e72c7e2c.jpg",  alt: "PFS heated booth — exterior install view" },
  { src: "/assets/IMG_0282_heated_2a60d21c.jpg",  alt: "PFS heated booth — exterior side view" },
  { src: "/assets/IMG_8441_heated_ac4423a3.jpg",              alt: "PFS heated booth — exterior front view" },
  { src: "/assets/heated_exterior_front_pfs_60f51615.jpg",  alt: "PFS heated booth — PFS branding, front doors, ETL badge" },
  { src: "/assets/heated_exterior_side_duct_f49e0e74.jpg",  alt: "PFS heated booth — exterior side view showing heat stack and ductwork" },
  { src: "/assets/heated_rear_burner_panel_b42c6dce.jpg",   alt: "PFS heated booth — rear burner panel, gas lines, and fire suppression" },
  { src: "/assets/heated_front_shop_dual_1c41d8ff.jpg",     alt: "PFS heated booth — dual booth install in auto shop, front view" },
  { src: "/assets/heated_side_exhaust_shop_527b7473.jpg",   alt: "PFS heated booth — side exhaust stack and control panel in shop" },
  { src: "/assets/pfs-heated-booth-exhaust-stack_ca825d7b.jpeg", alt: "PFS heated booth — exhaust stack, heater unit, and fire suppression install" },
  { src: "/assets/pfs-collision-repair-multi-booth-showroom_9f44f9a6.jpeg", alt: "PFS multi-booth showroom floor — three PFS booths" },
  { src: "/assets/pfs-apollo-amu-rooftop_9a42ebf0.jpg", alt: "PFS Apollo AMU — rooftop air make-up unit installed on booth" },
  { src: "/assets/pfs-helios-heated-booth-front_37d91be3.jpeg", alt: "PFS Helios heated spray booth — front view, triple-door entry, installed in shop" },
  { src: "/assets/pfs-helios-heated-booth-angled_d7ad0f9c.jpeg", alt: "PFS Helios heated spray booth — angled view showing AMU plenum and side exhaust" },
  { src: "/assets/pfs-helios-sdd-front-full_04883b65.jpg",    alt: "PFS Helios heated booth — front view, triple-door entry, Helios badge, installed in shop" },
  { src: "/assets/pfs-helios-sdd-side-angle_9f43d877.jpg",    alt: "PFS Helios heated booth — side angle view showing AMU plenum and booth body" },
  { src: "/assets/pfs-helios-sdd-door-closeup_888f9187.jpg",  alt: "PFS Helios heated booth — close-up of triple entry doors with Helios branding" },
  { src: "/assets/pfs-helios-sdd-side-install_fb8a847b.jpg",  alt: "PFS Helios heated booth — side view during installation showing AMU plenum structure" },
  { src: "/assets/pfs-helios-sdd-front-angle_77d8d4fa.jpg",   alt: "PFS Helios heated booth — front angle view showing doors and side plenum" },
  { src: "/assets/pfs-helios-sdd-side-rear_fa0388f5.jpg",     alt: "PFS Helios heated booth — rear side angle showing plenum framing during install" },
  { src: "/assets/pfs-helios-sdd-install-wide_a6bec064.jpg",  alt: "PFS Helios heated booth — wide install shot showing full booth and side plenum assembly" },
  { src: "/assets/pfs-helios-sdd-plenum-detail_d3b8c678.jpg", alt: "PFS Helios heated booth — detail view of side plenum filter bays and framing" },
  { src: "/assets/pfs-helios-sdd-jcb-install_cd269044.jpg",   alt: "PFS Helios heated booth — installation in progress with JCB telehandler lifting booth panels" },
];
...
/* ── COMPATIBLE MODELS ── */
const MODELS = [
  { name: "PFS Orion",  series: "Cross-Flow",    href: "/products/paint-booths/crossflow",     img: "/assets/orion-crossflow-render-v3_63c04d8e.webp",     desc: "Horizontal cross-flow airflow. Most cost-effective enclosed booth. Heated option adds direct or indirect-fired heat system with full spray/flash/bake modes." },
  { name: "PFS Helios", series: "Side Downdraft", href: "/products/paint-booths/side-downdraft", img: "/assets/pfs_helios_side_angle_final_73768c1f_5eaf3967.png", desc: "Side-wall exhaust plenums — no pit required. Heated option available with blanket intake upgrade and full temperature control." },
  { name: "PFS Zenith", series: "Full Downdraft", href: "/products/paint-booths/full-downdraft", img: "/assets/pfs_zenith_booth_v2_d56f2cd8_d3f181cd.png",        desc: "Full downdraft airflow through a raised basement or pit. Highest finish quality. Heated option with 180°F max bake and advanced data controls." },
];
...
export default function HeatedBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "Product",
      "name": "Heated Spray Booth",
      "description": "PFS heated spray booths combine spray and bake cycles in one enclosure. Integrated heat system accelerates cure times and improves finish quality.",
      "brand": {
        "@type": "Brand",
        "name": "PFS"
      },
      ...
      "offers": {
        ...
        "url": "https://pfsspraybooths.com/products/paint-booths/heated-booth"
      },
      "url": "https://pfsspraybooths.com/products/paint-booths/heated-booth"
    },
  });
      ...
      <section style={{ background: "#f5f5f5", padding: "4rem 0" }}>
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              { label: "Heated Air Make-Up Units", href: "/products/air-make-up-units/heated",  img: "/assets/pfs-amu-card_41f0dd88.jpg",          desc: "Conditioned make-up air to replace exhausted air and maintain positive booth pressure during heat cycles." },
              { label: "Mixing Rooms",             href: "/products/mixing-rooms",              img: "/assets/IMG_0498_a98f5f38.jpg",     desc: "Dedicated mixing rooms for safe paint preparation adjacent to your heated spray booth." },
              { label: "Prep Stations",            href: "/products/prep-support/prep-stations",             img: "/assets/pfs-prep-station-curtain-real_c07d32e0.jpg", desc: "Dedicated prep and masking stations to keep your heated booth running at full capacity." },
            ].map((item) => (
