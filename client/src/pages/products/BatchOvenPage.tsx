  ...
  return (
    <div className="bg-white">
      ...
      <section style={{
        ...
        <div className="container industry-ptb" style={{ position: "relative", zIndex: 2 }}>
          <nav
            className="batch-breadcrumb"
            style={{
              display: "flex",
              alignItems: "center",
              gap: "0.5rem",
          ...
          <span style={{ fontFamily: "'Barlow Condensed',sans-serif", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.18em", color: "rgba(255,255,255,0.7)", textTransform: "uppercase", display: "block", marginBottom: "1rem" }}>INDUSTRIAL OVENS — BATCH</span>
