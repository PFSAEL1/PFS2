...
const POWDER_IMG  = "/assets/pfs-powder-coating-card2_32de7c98.png";
const POWDER_VIDEO = "/assets/powder-coating-real-hero_8075e60b.mp4";  // MP4 hero — real person powder coating
const SPRAY_WASTE = "/assets/pfs-act-dustcollector-spraytowaste_3dd0ec94.jpeg";
const RECLAIM_IMG = "/assets/pfs-powder-reclaim-unit_48f7c437.png";
const AUTO_POWDER = "/assets/pfs-robotics-card_2aac132b.jpg";
...
export default function PowderBoothsHub() {
  useSEO({
    ...
    description: "PFS Nova Series powder coating booths include spray-to-waste and powder reclaim configurations for batch and production powder coating. High-efficiency cartridge filtration, optimal airflow, NFPA 33 and IFC Chapter 24 compliant. ETL/UL listed components. Custom sizes. Manufactured in Santa Rosa, CA.",
  ...
  return (
    <div>
      <PageHero
        ...
        subtitle="PFS Nova Series powder coating systems cover the full spectrum — from simple spray-to-waste booths to fully automated reclaim and robotic application systems."
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "mainEntity": [
            ...
            { "@type": "Question", "name": "Does a powder coating booth need to meet NFPA 33?",
              "acceptedAnswer": { "@type": "Answer", "text": "Yes. Powder coating booths must comply with NFPA 33 and IFC Chapter 24. These standards govern ventilation, electrical classification, fire suppression, and construction requirements. All PFS Nova Series powder coating booths are designed and built to meet or exceed these requirements." } },
