...
const FAQS = [
  ...
  { q: "What ventilation and dust collection does a blast room require?", a: "Blast rooms require sufficient airflow to maintain visibility during blasting and to capture airborne dust before it escapes the enclosure. OSHA and NFPA standards govern ventilation rates and dust collection requirements. PFS Atlas Series blast rooms are engineered with cartridge dust collectors sized to meet these requirements for the specific media and blasting volume." },
...
export default function BlastSystemsHub() {
  useSEO({
    ...
    description: "PFS Atlas Series blast rooms and abrasive blast booths are engineered for steel shot, aluminum oxide, garnet, and glass bead blasting. Cartridge dust collection, media reclaim, OSHA compliant ventilation, custom sizes. Factory-direct from Santa Rosa, CA. Built with ETL/UL listed components.",
