...
const HERO_POSTER = "/assets/pfs-prep-station-facility_f1978a4b.jpg";
const PREP_STATION_IMG = "/assets/pfs-prep-station-curtain-real_c07d32e0.jpg";
const MIX_ROOM_IMG = "/assets/IMG_0498_a98f5f38.jpg";
const SANDING_IMG = "/assets/pfs-sanding-booth-real_6c18c7ff.png";
const GRINDING_IMG = "/assets/pfs-grinding-booth-real_fabfee76.png";
const PAINT_WALL_IMG = "/assets/pfs-paint-walls-card_553fa1c5.png";
...
export default function PrepSupportHub() {
  ...
  useEffect(() => {
    ...
    script.text = JSON.stringify({
      ...
      "@type": "WebPage",
      "name": "Prep & Support Equipment — PFS Industrial Finishing Equipment",
      "url": "https://pfsspraybooths.com/products/prep-support",
      "description": "Complete prep and support equipment from PFS — prep stations, wash booths, mixing rooms, and paint walls. Engineered for professional finishing operations.",
      "publisher": {
        "@type": "Organization",
    ...
    <div>
      ...
      <section className="py-20 bg-white">
        <div className="container">
          ...
          {/* Large card grid */}
          <div data-animation="fadeIn" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {PREP_ITEMS.map((item) => (
