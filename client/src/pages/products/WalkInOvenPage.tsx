...
/* ── ASSETS ── */
const HERO_IMG = "/assets/vulcan-walkin-exterior_79315098.png";
const FEATURED_IMG = "/assets/vulcan-walkin-exterior_79315098.png";

const GALLERY_IMGS = [
  { src: "/assets/vulcan-walkin-exterior_79315098.png", alt: "PFS VULCAN walk-in oven — exterior front view, galvanized steel panels", pos: "center 40%" },
  { src: "/assets/IMG_4175b_e4e47527.jpg", alt: "PFS VULCAN walk-in oven — interior view with heating system", pos: "center 50%" },
  { src: "/assets/IMG_4182b_445e5513.jpg", alt: "PFS VULCAN walk-in oven — interior chamber and airflow system", pos: "center 50%" },
  { src: "/assets/IMG_4179_ca3158de.jpg", alt: "PFS VULCAN walk-in oven — side view with control panel", pos: "center 50%" },
];
...
/* ── RELATED PRODUCTS ── */
const PRODUCTS = [
  { label: "Batch Ovens", href: "/products/ovens/batch", img: "/assets/pfs-vulcan-oven-card_ad72eade_316de7d1.png", desc: "High-volume batch curing for powder and liquid paint." },
  { label: "Conveyor Ovens", href: "/products/ovens/conveyor", img: "/assets/conveyor-oven-entry_8df7b0be.png", desc: "Continuous curing for automated production lines." },
  { label: "Powder Coating Systems", href: "/products/powder-booths", img: "/assets/pfs-powder-coating-card2_32de7c98.png", desc: "Complete powder coating booths for batch and automated lines." },
  { label: "Prep Stations", href: "/products/prep-support/prep-stations", img: "/assets/pfs-prep-station-curtain-real_c07d32e0.jpg", desc: "Filtered prep areas for surface preparation before coating." },
];
...
export default function WalkInOvenPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "Product",
      "name": "Walk-In Industrial Oven",
      "description": "PFS walk-in ovens engineered for large parts, aerospace components, and high-volume production curing. Custom sizes, gas or electric heat.",
      "brand": {
        "@type": "Brand",
        "name": "PFS"
      },
      ...
      "offers": {
        ...
        "url": "https://pfsspraybooths.com/products/ovens/walk-in-oven"
      },
      "url": "https://pfsspraybooths.com/products/ovens/walk-in-oven"
    },
  });
    ...
    <div className="bg-white">
      ...
      <section style={{ position: "relative", minHeight: "clamp(340px, 55vh, 580px)", display: "flex", flexDirection: "column", justifyContent: "flex-end", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "8rem", paddingBottom: "3.5rem" }}>
          ...
          <span style={{ fontFamily: "'Barlow Condensed',sans-serif", fontSize: "0.72rem", fontWeight: 700, letterSpacing: "0.18em", color: "rgba(255,255,255,0.7)", textTransform: "uppercase", display: "block", marginBottom: "1rem" }}>INDUSTRIAL OVENS — WALK-IN</span>
            ...
            <>
                  ...
                  {WIDTH_KEYS.map((w, i, arr) => (
                    <button
                      ...
                      style={{
                        ...
                        background: selectedWidth === w ? BLUE : "transparent",
                        color: selectedWidth === w ? "#fff" : BLUE,
                        fontFamily: "'Barlow Condensed',sans-serif",
                        fontSize: "0.9rem",
                        fontWeight: 800,
                        letterSpacing: "0.1em",
                        textTransform: "uppercase",
                        border: "none",
                        borderRight: i < arr.length - 1 ? `1px solid ${BLUE}` : "none",
                        cursor: "pointer",
              ...
              {selectedWidth && availableDepths.length > 0 && (
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  <div className="depth-options" style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
                    {availableDepths.map((d) => (
                      <div key={d} onClick={() => setSelectedDepth(d)} style={{ background: selectedDepth === d ? BLUE : "#f5f5f5", border: `2px solid ${BLUE}`, padding: "1.25rem 1.5rem", minWidth: "180px", textAlign: "center", cursor: "pointer", transition: "background 0.15s,color 0.15s" }}>
