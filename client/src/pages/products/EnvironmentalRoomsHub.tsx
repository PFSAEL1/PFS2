...
const HUB_HERO = "/assets/pfs-environmental-room-exterior-showroom_08ee80dd.jpg";
// Process-Controlled card: IMG_0764 — clean exterior shot, smaller booth in white room
const PROCESS_CARD = "/assets/pfs-process-controlled-room-exterior_f4302d4b.jpg";
// Temperature-Controlled card: same hero (showroom exterior)
const TEMP_CARD = "/assets/pfs-environmental-room-exterior-showroom_08ee80dd.jpg";
// Enclosed Work card: large interior shot
const ENCLOSED_CARD = "/assets/pfs-environmental-room-interior-large_a5ff5797.jpg";
        ...
        <div className="container">
              ...
              <Link key="Temperature-Controlled Rooms" href="/products/environmental-rooms/temperature-controlled">
                <div className="product-card group">
                  ...
                  <div className="p-5">
                    ...
                    <p data-animation="slideLeft" style={{ fontFamily: "'Archivo Narrow', 'Inter', sans-serif", fontSize: "0.8rem", color: "#666", lineHeight: 1.6 }}>Precisely controlled temperature environments for coating and curing.</p>
                  </div>
                </div>
              </Link>
          ...
          <div className="mt-10 p-8 border border-gray-200 bg-gray-50">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <Link href="/contact/request-a-quote"><span data-animation="slideRight" className="btn-glow flex-shrink-0">Get Pricing <ArrowRight size={14} /></span></Link>
            </div>
          </div>
        </div>
      </section>
