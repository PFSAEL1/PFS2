      ...
      <section className="py-16 bg-white">
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <Link data-animation="slideRight" key="Temperature-Controlled Rooms" href="/products/environmental-rooms/temperature-controlled">
                <div className="product-card group">
                  <div className="overflow-hidden" style={{ height: "240px" }}>
                    <img data-animation="slideLeft" src={TEMP_CARD} alt="Temperature-Controlled Rooms" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                  </div>
                  <div className="p-5">
              ...
              <Link data-animation="slideLeft" key="Process-Controlled Rooms" href="/products/environmental-rooms/process-controlled">
                <div className="product-card group">
                  <div className="overflow-hidden" style={{ height: "240px" }}>
                    <img data-animation="slideLeft" src={PROCESS_CARD} alt="Process-Controlled Rooms" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                  </div>
                  <div className="p-5">
              ...
              <Link data-animation="slideLeft" key="Enclosed Work Environments" href="/products/environmental-rooms/enclosed-work">
                <div className="product-card group">
                  <div className="overflow-hidden" style={{ height: "240px" }}>
                    <img data-animation="slideLeft" src={ENCLOSED_CARD} alt="Enclosed Work Environments" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                  </div>
                  <div className="p-5">
