...
const HERO_IMG     = "/assets/pfs_zenith_front_v4_184fa602_6bff6565.webp";
const FEATURED_IMG = "/assets/zenith_angle_white_66934fee_ba0fd5d3.webp";

// Gallery = REAL PHOTOS ONLY — no renders, no duplicates, uniform card sizing
const GALLERY_IMGS = [
  { src: "/assets/pfs_zenith_6008_595d7725.webp",  alt: "PFS Zenith — open front, red Tesla inside, grated floor visible",          pos: "center 50%" },
  { src: "/assets/IMG_9176_39756636.jpg",           alt: "PFS Zenith — front-facing install, concrete floor, exhaust duct",          pos: "center 40%" },
  { src: "/assets/pfs_zenith_6010_a482a82c.webp",  alt: "PFS Zenith — open front, teal ceiling intake filters, grated floor pit",   pos: "center 45%" },
  { src: "/assets/IMG_0222_09b95832.jpg",           alt: "PFS Zenith — real installation photo",                                    pos: "center 50%" },
  { src: "/assets/IMG_6009_4924cb4c.jpg",           alt: "PFS Zenith — real installation photo",                                    pos: "center 50%" },
  { src: "/assets/IMG_6012_c043d75c.jpg",           alt: "PFS Zenith — real installation photo",                                    pos: "center 50%" },
    { src: "/assets/IMG_6135_0a36b459.jpg",           alt: "PFS Zenith — real installation photo",                            pos: "center 50%" },
  { src: "/assets/DowndraftwSRP_62a562d2.webp",      alt: "PFS Zenith — open doors, grated floor, car inside during installation", pos: "center 45%" },
  { src: "/assets/zenith_angle_white_66934fee_ba0fd5d3.webp",   alt: "PFS Zenith full-downdraft spray booth — clean white render, angled view",  pos: "center 50%" },
];
...
const PRODUCTS = [
  ...
  { label: "Semi-Downdraft Booths",href: "/products/paint-booths/semi-downdraft", img: "/assets/orion-semi-down-epoxy_9144ba19.png",              desc: "Ceiling-front intake, rear floor exhaust — better finish quality than cross-flow at a lower cost than full downdraft." },
];
...
export default function FullDowndraftBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "What is a full downdraft spray booth?", "acceptedAnswer": { "@type": "Answer", "text": "A full downdraft spray booth draws fresh air through ceiling intake filters, moves it straight down through the booth interior, and exhausts it through a grated floor plenum below the work surface. This top-to-bottom airflow carries overspray away from the part being painted, producing the cleanest finish quality of any enclosed booth configuration. The PFS Zenith series uses this design with ETL-listed components and a UL 508A control panel." } },
        { "@type": "Question", "name": "What is the difference between a full downdraft and a semi-downdraft paint booth?", "acceptedAnswer": { "@type": "Answer", "text": "A full downdraft booth exhausts air through a grated floor pit running the full length of the booth, requiring a concrete pit or raised floor system. A semi-downdraft booth exhausts through a rear wall plenum at floor level, eliminating the need for a pit. Full downdraft provides the most uniform airflow and is preferred for high-volume production and aerospace finishing. Semi-downdraft is lower cost to install and is popular for collision repair shops and smaller industrial operations." } },
        { "@type": "Question", "name": "Does a full downdraft paint booth require a concrete pit?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. A true full downdraft booth requires a below-grade exhaust pit or a raised floor grating system to collect and exhaust air from beneath the work surface. PFS Zenith booths can be configured with either a traditional concrete pit or a raised floor platform depending on your facility. If a pit is not feasible, the PFS Orion semi-downdraft or PFS Helios side-downdraft are no-pit alternatives." } },
        { "@type": "Question", "name": "What certifications does the PFS Zenith full downdraft booth carry?", "acceptedAnswer": { "@type": "Answer", "text": "The PFS Zenith full downdraft spray booth carries ETL listing for both the USA and Canada (Intertek), UL 508A certification on the industrial control panel, NFPA 33 compliance for spray application equipment, EPA air quality compliance, and OSHA workplace safety compliance. All fans are UL listed tube axial fans. Lighting fixtures are CID2 rated. Manufactured in Santa Rosa, CA." } },
        { "@type": "Question", "name": "What industries use full downdraft spray booths?", "acceptedAnswer": { "@type": "Answer", "text": "Full downdraft spray booths are used in automotive manufacturing and OEM production, aerospace and defense finishing, collision repair and auto body shops, industrial equipment coating, military vehicle refinishing, and any application requiring the highest level of finish quality and overspray control." } }
      ]
    },
  });
          ...
          <div style={{ display:"flex",flexWrap:"wrap",gap:"2.5rem",alignItems:"center",justifyContent:"space-between" }}>
            <div style={{ flex:"1 1 320px" }}>
              ...
              <div style={{ display:"flex",gap:"1rem",flexWrap:"wrap" }}>
                <Link href="/contact/request-a-quote?from=full-downdraft-booth">
                  <span data-animation="slideLeft" style={{ display:"inline-flex",alignItems:"center",gap:"0.5rem",background:"#dc2626",color:"#fff",fontFamily:"'Barlow Condensed',sans-serif",fontSize:"0.88rem",fontWeight:800,letterSpacing:"0.1em",textTransform:"uppercase",padding:"1rem 2rem",cursor:"pointer" }}>ASK ABOUT HEATED <ArrowRight size={15}/></span>
                </Link>
                <Link href="/products/paint-booths/heated">
                  <span data-animation="slideRight" style={{ display:"inline-flex",alignItems:"center",gap:"0.5rem",background:"transparent",color:"rgba(255,255,255,0.85)",border:"1.5px solid rgba(255,255,255,0.35)",fontFamily:"'Barlow Condensed',sans-serif",fontSize:"0.88rem",fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",padding:"1rem 2rem",cursor:"pointer" }}>VIEW HEATED BOOTHS <ArrowRight size={15}/></span>
                </Link>
              </div>
            </div>
