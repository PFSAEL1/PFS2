          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            ...
            <div className="flex flex-col min-[768px]:flex-row gap-4 justify-center max-[767px]:w-full">
              <Link
                ...
                href="/contact/request-a-quote?from=full-downdraft-booth"
        ...
        <div className="container">
          <div style={{ display: "flex", flexWrap: "wrap", gap: "2.5rem", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ flex: "1 1 320px" }}>
              ...
              <div className="flex flex-col min-[768px]:flex-row gap-4 max-[767px]:w-full">
                <Link
                  href="/contact/request-a-quote?from=full-downdraft-booth"
                  data-animation="slideLeft"
                  className="w-full min-[768px]:w-auto"
                >
                  ...
                  >
                    ASK ABOUT HEATED <ArrowRight size={15} />
                  </span>
                </Link>
                ...
                >
                  ...
                  >
                    VIEW HEATED BOOTHS <ArrowRight size={15} />
                  </span>
                </Link>
              </div>
            </div>
