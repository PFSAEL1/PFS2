    ...
    <div style={{ fontFamily:"'Inter',sans-serif" }}>
      ...
      <section style={{ padding: "3rem 0", backgroundColor: "#111" }}>
        <div className="container">
          ...
          <h2 style={{ fontFamily: "'Barlow Condensed','Oswald', sans-serif", fontSize: "clamp(1.5rem,3vw,2.2rem)", fontWeight: 800, textTransform: "uppercase", color: "#fff", marginBottom: "1.5rem", letterSpacing: "-0.01em" }}>See It Running</h2>
