...
const FEATURES_HIDDEN = [
  ...
  },
  {
    ...
    body: "PFS Nova Series spray-to-waste booths ship to all 50 states. Factory-direct pricing, fast lead times, and dedicated project support from order through installation. Manufactured in Santa Rosa, CA.",
  },
];
...
const RELATED_PRODUCTS = [
  ...
  },
  {
    ...
    img: "/assets/pfs-powder-reclaim-unit_48f7c437.png",
  ...
  return (
    <div style={{ fontFamily: "'Inter',sans-serif" }}>
      ...
      <section style={{ position: "relative", minHeight: "clamp(420px,55vh,680px)", display: "flex", alignItems: "flex-end", overflow: "hidden", background: "#0a1628" }}>
        ...
        <div className="container industry-ptb" style={{ zIndex: 1 }}>
      ...
      {/* ── BOOTH IN ACTION VIDEO ── */}
      <section style={{ padding: "3rem 0", backgroundColor: "#111" }}>
        <div className="container">
          <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: "0.7rem", fontWeight: 700, letterSpacing: "0.14em", color: "rgba(255,255,255,0.5)", display: "block", marginBottom: "0.5rem", textTransform: "uppercase" }}>BOOTH IN ACTION</span>
          <h2 data-animation="slideLeft" style={{ fontFamily: "'Barlow Condensed','Oswald', sans-serif", fontSize: "clamp(1.5rem,3vw,2.2rem)", fontWeight: 800, textTransform: "uppercase", color: "#fff", marginBottom: "1.5rem", letterSpacing: "-0.01em" }}>See It Running</h2>
          <div style={{ position: "relative", width: "100%", maxWidth: 960, margin: "0 auto", background: "#000", lineHeight: 0, borderRadius: "2px", overflow: "hidden" }}>
            <video
              autoPlay
              muted
              loop
        ...
        <div className="container">
          <div style={{ textAlign: "center", marginBottom: "2rem" }}>
            ...
            <p data-animation="slideLeft" style={{ fontFamily: "'Inter',sans-serif", fontSize: "0.9rem", color: "#666", maxWidth: "560px", margin: "0 auto", lineHeight: 1.7 }}>
              PFS Nova Series spray-to-waste booths are available with two distinct filtration approaches. Select a model below to see how each system works.
            </p>
          </div>
              ...
              {selectedWidth === "Custom" && (
                <div style={{ background: "#fff", border: `2px solid ${BLUE}`, padding: "2rem", marginBottom: "2rem", maxWidth: "540px" }}>
                  ...
                  <p style={{ fontFamily: "'Inter',sans-serif", fontSize: "0.88rem", color: "#555", lineHeight: 1.65, marginBottom: "1.25rem" }}>
                    PFS Nova Series spray-to-waste booths are engineered to order for any part size, production volume, or facility constraint. Provide your part dimensions and production requirements and our team will configure the right booth for your application.
                  </p>
        ...
        <div className="container" style={{ maxWidth: "820px" }}>
          ...
          {[
            ...
            },
            {
              ...
              a: "Yes. PFS Nova Series spray-to-waste booths are available with conveyor entry and exit openings for integration into continuous powder coating lines. Parts move through the booth on an overhead or floor conveyor while the filtration system operates continuously.",
            },
          ].map((item, i) => (
            <details
              key={i}
      ...
      <section style={{ background: "linear-gradient(135deg, #060d1a 0%, #0b1628 60%, #060d1a 100%)", borderTop: "3px solid #1B3A6B", padding: "3rem 0" }}>
        <div className="container" style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.25rem" }}>
          ...
          <p style={{ fontFamily: "'Archivo Narrow','Inter',sans-serif", fontSize: "0.9rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.65, maxWidth: "560px", margin: 0 }}>
            PFS offers preventative maintenance programs, filter service, airflow verification, controls calibration, and emergency response for spray-to-waste powder coating booths.
          </p>
          <Link href="/service/spray-to-waste">
