...
/* ── ASSETS ── */
const HERO_VIDEO   = "/assets/pfs-open-face-booth-hero-v2_1c16c291.mp4";
const HERO_POSTER  = "/assets/pfs-open-face-render_2a9e6ee7.png";
const FEATURED_IMG = "/assets/openface_front_white_hd_d30bdd79.webp";

const GALLERY_IMGS = [
  // ── REAL INSTALL PHOTOS FIRST ──
  { src: "/assets/openface-exterior-pfs-logo_dc802808.png",          alt: "PFS open face booth — exterior side view with PFS logo and open front",               pos: "center 50%" },
  { src: "/assets/openface-frontview-filters_6ea7922c.png",          alt: "PFS open face booth — full front view showing green exhaust filter wall",             pos: "center 50%" },
  { src: "/assets/openface-install-wide_e511c651.jpg",               alt: "PFS open face booth installation — wide shop view with booth in place",                pos: "center 50%" },
  { src: "/assets/openface-install-side_d0334da6.jpg",               alt: "PFS open face booth installation — side angle showing PFS branding and open front",    pos: "center 50%" },
  { src: "/assets/openface-interior-ceiling_e309b659.png",          alt: "PFS open face booth interior — ceiling lights and green exhaust filter wall",         pos: "center 40%" },
  { src: "/assets/IMG_9325(1)_94175ee9.jpg",                     alt: "PFS open face spray booth in use — two operators finishing chairs in production",      pos: "center 40%" },
  { src: "/assets/IMG_3186_8c282fe6.jpg",                        alt: "PFS open face booth installation — real field photo showing open front and exhaust",   pos: "center 40%" },
  { src: "/assets/pfs-open-face-real-1_c04e784a.jpeg",           alt: "PFS open face spray booth — lit interior with fiberglass exhaust filters",            pos: "center 40%" },
  { src: "/assets/pfs-open-face-real-2_23312420.jpeg",           alt: "PFS open face spray booth — exterior front view with exhaust stack",                  pos: "center 50%" },
  // ── RENDERS ──
  { src: "/assets/openface14_chairs_white_hd_d4d1c048.webp",   alt: "PFS Orion Open Face booth — white background render with chairs, angled view",       pos: "center 50%" },
  { src: "/assets/openface14_chairs_epoxy_v2_hd_8448a8ad.webp", alt: "PFS Orion Open Face booth — epoxy floor render with chairs and bench, angled view",   pos: "center 50%" },
  { src: "/assets/openface_chairs_epoxy_v3_hd_be637db2.webp",   alt: "PFS Orion Open Face booth — epoxy floor render, dark studio background",              pos: "center 50%" },
  { src: "/assets/openface_front_white_hd_d30bdd79.webp",       alt: "PFS Orion Open Face booth — front view render, white background, filter wall visible", pos: "center 50%" },
];
...
export default function OpenFaceBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "Product",
      "name": "Open Face Spray Booth",
      "description": "PFS open face spray booths for large parts, structural steel, and applications where full enclosure is not practical. NFPA 33 compliant.",
      "brand": {
        "@type": "Brand",
        "name": "PFS"
      },
      ...
      "offers": {
        ...
        "url": "https://pfsspraybooths.com/products/paint-booths/open-face-booth"
      },
      "url": "https://pfsspraybooths.com/products/paint-booths/open-face-booth"
    },
  });
