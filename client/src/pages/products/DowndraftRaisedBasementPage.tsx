  ...
  return (
    <div className="bg-white">
      ...
      <div className="md:hidden" style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 50, display: "flex", borderTop: "2px solid #e5e7eb", boxShadow: "0 -4px 16px rgba(0,0,0,0.12)" }}>
        <a data-animation="slideLeft" href="tel:8885457715" style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: "0.4rem", background: "#fff", color: BLUE, fontFamily: "'Barlow Condensed',sans-serif", fontSize: "0.82rem", fontWeight: 800, letterSpacing: "0.08em", textTransform: "uppercase", padding: "1rem 0.5rem", textDecoration: "none", minHeight: "56px" }}>
          📞 (888) 545-7715
        </a>
        <Link data-animation="slideRight" href="/contact/request-a-quote?from=full-downdraft-booth" style={{ flex: 2, textDecoration: "none" }}>
