...
/* ── CDN ASSETS ── */
const HERO_IMG = "/assets/semi-down-open-front-hero_5ce2543a_d5528751.png";
const FEATURED_IMG = "/assets/orion-semi-down-epoxy_9144ba19.png";

// Gallery = REAL PHOTOS ONLY
const GALLERY_IMGS = [
  { src: "/assets/semi-down-exterior-front_434341db.jpg", alt: "PFS Orion semi-downdraft booth — exterior 3/4 view with exhaust stack", pos: "center 50%" },
  { src: "/assets/semi-down-exterior-front_434341db.jpg", alt: "PFS Orion semi-downdraft booth — exterior straight-on front view", pos: "center 50%" },
  { src: "/assets/semi-down-open-doors_b8b93fe8.jpg", alt: "PFS Orion semi-downdraft booth — open doors showing yellow exhaust filter wall", pos: "center 50%" },
  { src: "/assets/semi-down-interior_8fc4094d.jpg", alt: "PFS Orion semi-downdraft booth — interior wide shot with ceiling intake and lighting", pos: "center 50%" },
  { src: "/assets/pfs-gallery-img0916_b2d05dd2.jpg", alt: "PFS spray booth — real installation photo", pos: "center 50%" },
  { src: "/assets/semi-down-open-doors_1d86b013.jpg", alt: "PFS spray booth — real installation photo", pos: "center 50%" },
  { src: "/assets/pfs-gallery-img0913_83a94ba3.jpg", alt: "PFS spray booth — real installation photo", pos: "center 50%" },
  { src: "/assets/pfs-gallery-img0914_0ce05fb0.jpg", alt: "PFS spray booth — real installation photo", pos: "center 50%" },
  { src: "/assets/orion-semi-down-epoxy_9144ba19.png", alt: "PFS Orion semi-downdraft spray booth — clean white render with epoxy floor", pos: "center 50%" },
];
...
const PRODUCTS = [
  ...
  { label: "Cross-Flow Booths", href: "/products/paint-booths/crossflow-booth", img: "/assets/orion-crossflow-render-v3_63c04d8e.webp", desc: "Horizontal airflow — the most cost-effective enclosed booth for automotive and industrial finishing." },
];
...
export default function SemiDowndraftBoothPage() {
  useSEO({
    ...
    jsonLd: {
      ...
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "What is a semi-downdraft spray booth?", "acceptedAnswer": { "@type": "Answer", "text": "A semi-downdraft spray booth draws air in through ceiling intake filters at the front of the booth, sweeps it diagonally across the work area, and exhausts it through a rear wall plenum at floor level. This eliminates the need for a concrete floor pit while delivering near-downdraft finish quality. The PFS Orion series uses this configuration with ETL-listed components and a UL 508A control panel." } },
        { "@type": "Question", "name": "Does a semi-downdraft booth require a floor pit?", "acceptedAnswer": { "@type": "Answer", "text": "No. The semi-downdraft design exhausts air through a rear wall plenum at floor level, not through the floor itself. No underground concrete pit is required, significantly reducing installation cost and making it suitable for slab-on-grade facilities and retrofit installations." } },
        { "@type": "Question", "name": "What is the difference between a semi-downdraft and a cross-flow spray booth?", "acceptedAnswer": { "@type": "Answer", "text": "A cross-flow booth draws air in through the front wall and exhausts through the rear wall at the same height, creating horizontal airflow across the booth. A semi-downdraft draws air from the front ceiling and exhausts at the rear floor, creating a diagonal downward sweep. Semi-downdraft provides better overspray control and finish quality than cross-flow because the airflow moves away from the painter and part." } },
        { "@type": "Question", "name": "What certifications does the PFS Orion semi-downdraft booth carry?", "acceptedAnswer": { "@type": "Answer", "text": "The PFS Orion semi-downdraft spray booth carries ETL listing for both the USA and Canada (Intertek), UL 508A certification on the industrial control panel, NFPA 33 compliance, EPA air quality compliance, and OSHA workplace safety compliance. All fans are UL listed tube axial fans. Lighting fixtures are CID2 rated. Manufactured in Santa Rosa, CA." } },
        { "@type": "Question", "name": "Is a semi-downdraft booth good for automotive refinishing?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Semi-downdraft booths are one of the most popular configurations for automotive collision repair and refinishing shops. The diagonal airflow pattern effectively removes overspray from the work area, and the no-pit design makes installation straightforward in most shop environments. The PFS Orion is used in collision repair facilities, fleet shops, and general automotive refinishing operations nationwide." } }
      ]
    },
  });
    ...
    <div className="bg-white">
      ...
      <section style={{
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, paddingTop: "6rem", paddingBottom: "clamp(5rem, 12vw, 7rem)" }}>
          ...
          >
            Near-downdraft airflow quality — without the concrete pit. Air enters through
            front ceiling intake filters, sweeps floor-level toward the rear, and exhausts
            through a rear wall plenum. No underground excavation required. Ideal for
            collision repair shops, automotive refinishing, and industrial facilities
            where floor modification is not feasible. ETL/UL listed components. UL 508A
            panel. NFPA 33 compliant. Ships nationally.
          </p>
