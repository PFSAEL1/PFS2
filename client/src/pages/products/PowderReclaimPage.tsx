...
const HERO_VIDEO = "/assets/pfs-nova-powder-reclaim-hero_8e1b0424.mp4";
const FEATURED_IMG = "/assets/pfs-powder-reclaim-unit_48f7c437.png";

const GALLERY_IMGS = [
  { src: "/assets/pfs-powder-reclaim-unit_48f7c437.png", alt: "PFS Nova Series powder reclaim booth — full unit exterior view", pos: "center 50%" },
  { src: "/assets/pfs-nova-powder-reclaim_2a87798e.png", alt: "PFS Nova powder reclaim system — cyclone recovery unit", pos: "center 50%" },
  { src: "/assets/pfs-powder-recovery-lines_a80d3e22.png", alt: "PFS powder recovery production line — conveyor integration", pos: "center 50%" },
  { src: "/assets/pfs-powder-coating-action_2ede4cbe.png", alt: "PFS Nova Series powder coating booth — operator applying powder", pos: "center 40%" },
  { src: "/assets/pfs-robotic-arm-red-spray_90b1e89b.png", alt: "PFS robotic powder application — automated finishing system", pos: "center 50%" },
  { src: "/assets/pfs-auto-powder-line1_3bb98899.png", alt: "PFS automated powder coating line with conveyor and reclaim", pos: "center 50%" },
];
...
const FEATURES_HIDDEN = [
  ...
  },
  {
    ...
    body: "PFS Nova Series powder reclaim booths ship to all 50 states. Factory-direct pricing, fast lead times, and dedicated project support from order through installation. Manufactured in Santa Rosa, CA.",
  },
];
...
const RELATED_PRODUCTS = [
  {
    ...
    img: "/assets/conveyor-oven-entry_8df7b0be.png",
  ...
  },
  {
    ...
    img: "/assets/pfs-auto-powder-line1_3bb98899.png",
    ...
    <div style={{ fontFamily: "'Inter',sans-serif" }}>
      ...
      <section style={{ position: "relative", minHeight: "clamp(420px,55vh,680px)", display: "flex", alignItems: "flex-end", overflow: "hidden", background: "#0a1628" }}>
        ...
        >
          ...
          <img src={HERO_IMG} alt="PFS Nova Series powder reclaim booth — cyclone powder recovery system for high-volume powder coating" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        </video>
        ...
        <div className="container industry-ptb" style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="container">
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            <div style={{ textAlign: "center" }}>
              ...
              <h2 data-animation="slideLeft" style={{ fontFamily: "'Barlow Condensed','Oswald',sans-serif", fontSize: "clamp(1.6rem,3vw,2.4rem)", fontWeight: 800, color: "#111", letterSpacing: "-0.01em", marginBottom: "0.5rem" }}>PFS Nova Series Powder Reclaim System — Cyclone Recovery</h2>
            ...
            <div style={{ width: "100%", maxWidth: "900px", overflow: "hidden", borderRadius: "2px" }}>
              <img src={FEATURED_IMG} alt="PFS Nova Series powder reclaim booth — featured installation, cyclone recovery system" style={{ width: "100%", height: "auto", display: "block", objectFit: "cover", objectPosition: "center" }} />
            </div>
      ...
      <section style={{ background: "#fff", padding: "4rem 0", borderBottom: "1px solid #e5e7eb" }}>
        <div className="container">
          ...
          <div data-animation="fadeIn" className="grid md:grid-cols-4 gap-5">
            {[
              ...
              {selectedWidth === "Custom" && (
                <div style={{ background: "#fff", border: `2px solid ${BLUE}`, padding: "2rem", marginBottom: "2rem", maxWidth: "540px" }}>
                  ...
                  <p style={{ fontFamily: "'Inter',sans-serif", fontSize: "0.88rem", color: "#555", lineHeight: 1.65, marginBottom: "1.25rem" }}>
                    PFS Nova Series powder reclaim booths are engineered to order for any part size, production volume, conveyor configuration, or facility constraint. Provide your part dimensions, production rate, and powder chemistry and our team will configure the right system.
                  </p>
        ...
        <div className="container" style={{ maxWidth: "820px" }}>
          ...
          {[
            ...
            },
            {
              ...
              a: "PFS Nova Series powder reclaim booths are built to NFPA 33 and IFC Chapter 24 standards with ETL/UL certified components and a UL 508A certified control panel. OSHA 1910.94 compliant ventilation design.",
            },
          ].map((item, i) => (
            <details
              key={i}
      ...
      <section style={{ background: "linear-gradient(135deg, #060d1a 0%, #0b1628 60%, #060d1a 100%)", borderTop: "3px solid #1B3A6B", padding: "3rem 0" }}>
        <div className="container" style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.25rem" }}>
          <div style={{ fontFamily: "'Chakra Petch','Barlow Condensed',sans-serif", fontSize: "0.6rem", fontWeight: 700, color: "#6BA3E0", letterSpacing: "0.2em", textTransform: "uppercase" }}>PFS SERVICE DEPARTMENT</div>
          <h2 style={{ fontFamily: "'Chakra Petch','Barlow Condensed',sans-serif", fontSize: "clamp(1.4rem,3vw,2rem)", fontWeight: 900, color: "#fff", textTransform: "uppercase", letterSpacing: "-0.01em", margin: 0, lineHeight: 1.1 }}>Service This Equipment</h2>
          <p style={{ fontFamily: "'Archivo Narrow','Inter',sans-serif", fontSize: "0.9rem", color: "rgba(255,255,255,0.65)", lineHeight: 1.65, maxWidth: "560px", margin: 0 }}>
            PFS offers preventative maintenance programs, cyclone service, airflow verification, controls calibration, and emergency response for powder reclaim systems.
          </p>
          <Link href="/service/powder-reclaim">
            <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", fontFamily: "'Chakra Petch','Barlow Condensed',sans-serif", fontSize: "0.75rem", fontWeight: 800, letterSpacing: "0.14em", textTransform: "uppercase", color: "#fff", background: "linear-gradient(90deg,#1B3A6B,#2A5298)", padding: "0.75rem 1.75rem", borderRadius: "2px", border: "1px solid rgba(107,163,224,0.4)", boxShadow: "0 0 20px rgba(42,82,152,0.4)", cursor: "pointer" }}>
              View Service Options <ArrowRight size={14} />
            </div>
          </Link>
        </div>
      </section>
