      ...
      <section style={{ position: "relative", minHeight: "clamp(420px,55vh,680px)", display: "flex", alignItems: "flex-end", overflow: "hidden", background: "#0a1628" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1, paddingBottom: "clamp(3rem,6vw,5rem)" }}>
          ...
          <h1 data-animation="slideLeft"
            style={{ fontFamily: "'Barlow Condensed','Oswald',sans-serif", fontSize: "clamp(2.2rem,6vw,4.2rem)", fontWeight: 900, color: "#fff", letterSpacing: "-0.02em", lineHeight: 1.05, marginBottom: "1rem", maxWidth: "700px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "1rem" }}>
            <Link data-animation="slideLeft"
              href="/contact/request-a-quote?from=powder-reclaim">
