...
export default function OutdoorBoothPage() {
  useSEO({
    ...
    canonical: "https://www.pfsspraybooths.com/products/outdoor-booths",
    jsonLd: {
    ...
    <div className="bg-white">
        ...
        <div className="container site-hero-content-wrapper" style={{ position: "relative", zIndex: 2 }}>
          ...
          >
            <Link
              ...
              href="/contact/request-a-quote?from=outdoor-booth"
      ...
      <section style={{ background: "#f5f5f5", padding: "4rem 0 3rem" }}>
        <div className="container">
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            ...
            <div
              data-animation="slideRight"
              className="btn-glow-wrapper flex flex-wrap justify-center gap-4 md:w-auto margin:0 auto"
            >
              <Link
                href="/contact/request-a-quote?from=outdoor-booth"
      ...
      <section style={{ background: "#fff", padding: "4rem 0" }}>
        <div className="container">
          ...
          <div data-animation="slideRight" style={{ textAlign: "center", margin: "2rem auto", display: "block" }}>
            <Link style={{ textAlign: "center", margin: "2rem auto", display: "block" }}
              href="/contact/request-a-quote?from=outdoor-booth"
