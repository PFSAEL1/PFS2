...
export default function CrossFlowBoothPage() {
  ...
  >
    <span
      className="btn-glow-white flex w-full items-center justify-center gap-2"
      style={{
        ...
        <div className="container">
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1.5rem" }}>
            ...
            <div className="flex flex-col min-[768px]:flex-row gap-4 justify-center max-[767px]:w-full">
              ...
              <Link
                data-animation="slideRight"
                href="/products/paint-booths/crossflow-all"
                className="max-[767px]:w-full max-[767px]:block"
              >
                <span className="btn-outline flex items-center justify-center gap-2 max-[767px]:w-full">
                  SEE ALL CROSS-FLOW BOOTHS <ArrowRight size={15} />
                </span>
              </Link>
            </div>
          </div>
      ...
      <section style={{ background: "#fff", padding: "4rem 0" }}>
        <div className="container">
          ...
          >
            <Link
              href="/contact/request-a-quote?from=crossflow-booth"
              className="block max-[767px]:w-full"
            >
        ...
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <div className="flex flex-col min-[768px]:flex-row gap-4 justify-center max-[767px]:w-full">
            <Link
              ...
              className="max-[767px]:w-full max-[767px]:block"
            >
              <span className="btn-glow-white flex items-center justify-center gap-2 max-[767px]:w-full">
            ...
            >
              <span
                className="btn-glow-white flex items-center justify-center gap-2 max-[767px]:w-full"
                style={{
                  background: "transparent",
                  color: "#fff",
                  boxSizing: "border-box",
