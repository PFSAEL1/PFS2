...
const HERO_IMG   = "/assets/IMG_0499_cb046812.jpg";
const HERO_VIDEO = "/assets/mixing-room-hero_5bbece5b.mp4";
const FEATURED_IMG = "/assets/IMG_0500_f0ae47bd.jpg";

const GALLERY_IMGS = [
  { src: "/assets/mixing-room-front_aaede323.jpg",       alt: "PFS mixing room — front view with PFS branding",             pos: "center 35%" },
  { src: "/assets/IMG_0632_68d81cc2.jpg",                alt: "PFS mixing room — double-door entry with exhaust stack",      pos: "center 40%" },
  { src: "/assets/IMG_0633_bba53fbe.jpg",                alt: "PFS mixing room — side view showing exhaust and controls",    pos: "center 50%" },
  { src: "/assets/IMG_0223_897429e6.jpg",                alt: "PFS mixing room — interior setup",                           pos: "center 50%" },
  { src: "/assets/mixing-room-fullsize_eac6ee2f.jpg",    alt: "PFS mixing room — full-size exterior view",                  pos: "center 50%" },
  { src: "/assets/IMG_2132_9f9c9e9a.jpg",                alt: "PFS mixing room — install view",                             pos: "center 50%" },
  { src: "/assets/IMG_5393_3b824496.jpg",                alt: "PFS mixing room — shop installation",                        pos: "center 50%" },
  { src: "/assets/IMG_0498_a98f5f38.jpg", alt: "PFS mixing room — render overview",                         pos: "center 50%" },
];
...
const PRODUCTS = [
  { label: "Cross-Flow Spray Booths", href: "/products/paint-booths/crossflow",       img: "/assets/orion-crossflow-render-v3_63c04d8e.webp",              desc: "Horizontal airflow enclosed booths — the most cost-effective enclosed booth for automotive and industrial finishing." },
  ...
  { label: "Batch Ovens",             href: "/products/ovens/batch",                  img: "/assets/IMG_4175_a7a2b2ea.jpg",                          desc: "Industrial batch ovens for powder coat curing, heat treating, and drying applications." },
];
