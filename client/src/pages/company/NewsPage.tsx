    ...
    <div style={{ background: "#fff" }}>
      ...
      <section style={{ background: "#fff", padding: "4rem 0" }}>
        <div className="container">
          ...
          <div data-animation="fadeIn" style={{ display:"flex",flexDirection:"column",gap:"1.5rem" }}>
