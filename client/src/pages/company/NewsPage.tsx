...
const BLUE = "#1B3A6B";
const PRESS_PHOTO = "/assets/1E5D91B3-7FA4-46B5-866D-BBA68134E884_4f79ba41.jpeg";
const SERVICE_LOGO = "/assets/PFSSERVICELOGO_d486d305.png";
const IMG = "/assets/news-press.png";
...
export default function NewsPage() {
  useSEO({
    title: "News & Press | PFS Filter Division & Maintenance Division Expansion | PFS Industrial Finishing Equipment",
    description: "PFS announces expansion of its Filter Division and Maintenance Division. Read the latest news from PFS Industrial Finishing Equipment (formerly Platinum Finishing Systems) — spray booth manufacturer based in Santa Rosa, CA.",
    ...
    `,
      ...
      >
        ...
        >
          ...
          >
            The latest from PFS Industrial Finishing Equipment —
            product launches, service expansions, and company milestones.
          </p>
        </div>
      </section>
            ...
            <div style={{ padding: "3rem 3rem 2.5rem" }}>
              ...
              <div style={{ marginBottom: "2rem", display: "flex", alignItems: "center", gap: "1rem", padding: "1.25rem 1.5rem", background: "#f0f4f9", borderLeft: `4px solid ${BLUE}` }}>
                ...
                <p style={{ fontFamily: "'Archivo Narrow','Inter',sans-serif", fontSize: "0.85rem", color: "#444", lineHeight: 1.6, margin: 0 }}>
                  <strong>PFS Service</strong> is the dedicated service division of PFS Industrial Finishing Equipment, providing preventive maintenance, emergency repair, NFPA 33 inspections, and filter supply programs for spray booth and finishing equipment operators nationwide.
                </p>
              </div>
              ...
              <div style={{ fontFamily: "'Archivo Narrow','Inter',sans-serif", fontSize: "0.95rem", color: "#333", lineHeight: 1.85 }}>
                ...
                <h3 style={{ fontFamily: "'Chakra Petch','Barlow Condensed',sans-serif", fontSize: "1.1rem", fontWeight: 700, color: "#111", textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: "0.75rem", marginTop: "2rem" }}>
                  About PFS Industrial Finishing Equipment
                </h3>
                <p style={{ marginBottom: "1.5rem" }}>
                  PFS Industrial Finishing Equipment (formerly Platinum Finishing Systems) is a vertical manufacturer of industrial spray paint booths, powder coating systems, blast rooms, industrial ovens, air make-up units, and finishing automation equipment. Founded in 2012 and headquartered in Santa Rosa, California, PFS designs, fabricates, and assembles all equipment at its Northern California facility using domestic steel and components. PFS equipment is ETL-listed, built to NFPA 33, and supported by UL 508A certified control panels.
                </p>
              </div>
