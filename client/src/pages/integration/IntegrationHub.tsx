...
const HERO = "/assets/pfs-liquid-paint-line-real_2f9e33d5.jpg";  // Real PFS liquid paint line photo
const HERO_VIDEO = "/assets/pfs-integration-hub-hero_cff3efb1.mp4";
const POWDER = "/assets/pfs-powder-coating-line-real_9473890b.png";
const PAINT = "/assets/pfs-robotics-card_2aac132b.jpg";  // Robotic arms spraying red — Liquid Paint Lines card
const INTEGRATED_SYSTEM = "/assets/pfs-integrated-system-line_ad6dc185.png";  // Real PFS integrated finishing line — conveyor + PFS oven
const ROBOT = "/assets/pfs-robotic-cell-orion-r_4f0c33bb_2d3b524c.png";
// Conveyor: real overhead photo — distinct from the PAINT conveyor render
const CONVEYOR_REAL = "/assets/yellow-conveyor-system_8b253b1f.jpg";  // Real PFS yellow overhead conveyor system
